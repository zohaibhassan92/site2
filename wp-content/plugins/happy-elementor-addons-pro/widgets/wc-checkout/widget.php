...
class WC_Checkout extends Base {
	...
	protected function register_style_controls() {
		$this->_register_controls_style_sections();

		$this->_register_controls_style_inputs();

		$this->_register_controls_style_coupon_bar();

		$this->_register_controls_style_coupon_apply_box();

		$this->_register_controls_style_headings();

		$this->_register_controls_style_billing_details();
	}
	...
	protected function _register_controls_style_sections() {
		$this->start_controls_section(
	...
	protected function _register_controls_style_inputs() {
		$this->start_controls_section(
	...
	protected function _register_controls_style_coupon_bar() {
		$this->start_controls_section(
	...
	protected function _register_controls_style_coupon_apply_box() {
	...
	protected function _register_controls_style_headings() {
		$this->start_controls_section(
	...
	protected function _register_controls_style_billing_details() {
		$this->start_controls_section(
