...
class Modal_Popup extends Base {
	...
	protected function register_content_controls() {
		$this->_section_modal_popup_trigger();
		$this->_section_modal_popup();
		$this->_section_modal_popup_settings();
	}

	protected function _section_modal_popup_trigger() {
	...
	protected function _section_modal_popup() {
	...
	protected function _section_modal_popup_settings() {
	...
	protected function register_style_controls() {
		$this->_section_button_style();
		$this->_section_trigger_image_style();
		$this->_section_popup_style();
	}

	protected function _section_button_style() {
	...
	protected function _section_trigger_image_style() {
	...
	protected function _section_popup_style() {
