...
class WC_Cart extends Base {
	...
	protected function register_content_controls() {
		$this->_register_controls_content_general();
	}

	protected function register_style_controls() {
		$this->_register_controls_style_cart_table();

		$this->_register_controls_style_coupon();

		$this->_register_controls_style_update_cart_button();

		$this->_register_controls_style_totals_heading();

		$this->_register_controls_style_cart_totals();

		$this->_register_controls_style_checkout_button();

		$this->_register_controls_style_cross_sells();
	}

	protected function _register_controls_style_cart_table() {
	...
	protected function _register_controls_content_general() {
		$this->start_controls_section(
	...
	protected function _register_controls_style_coupon() {
		$this->start_controls_section(
			'form_coupon_style',
			[
	...
	protected function _register_controls_style_totals_heading() {
		$this->start_controls_section(
	...
	protected function _register_controls_style_cart_totals() {
		$this->start_controls_section(
	...
	protected function _register_controls_style_update_cart_button() {
	...
	protected function _register_controls_style_checkout_button() {
        $this->start_controls_section(
	...
	protected function _register_controls_style_cross_sells() {
