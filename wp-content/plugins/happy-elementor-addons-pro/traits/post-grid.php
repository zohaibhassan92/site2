...
trait Post_Grid_Markup {
    ...
    public static function render_classic_markup( $settings = [], $post ) {
    ...
    public static function render_hawai_markup( $settings = [], $post ) {
        $featured_image = self::get_value( 'featured_image', $settings );
        $featured_image_size = self::get_value( 'featured_image_size', $settings );
        $show_badge = self::get_value( 'show_badge', $settings );
        $taxonomy_badge = self::get_value( 'taxonomy_badge', $settings );
    ...
    public static function render_standard_markup( $settings = [], $post ) {
        $featured_image = self::get_value( 'featured_image', $settings );
        $featured_image_size = self::get_value( 'featured_image_size', $settings );
        $show_badge = self::get_value( 'show_badge', $settings );
        $taxonomy_badge = self::get_value( 'taxonomy_badge', $settings );
    ...
    public static function render_monastic_markup( $settings = [], $post ) {
        $featured_image = self::get_value( 'featured_image', $settings );
        $featured_image_size = self::get_value( 'featured_image_size', $settings );
        $show_badge = self::get_value( 'show_badge', $settings );
        $taxonomy_badge = self::get_value( 'taxonomy_badge', $settings );
    ...
    public static function render_stylica_markup( $settings = [], $post ) {
        $featured_image = self::get_value( 'featured_image', $settings );
        $featured_image_size = self::get_value( 'featured_image_size', $settings );
        $show_badge = self::get_value( 'show_badge', $settings );
        $taxonomy_badge = self::get_value( 'taxonomy_badge', $settings );
    ...
    public static function render_outbox_markup( $settings = [], $post ) {
        $featured_image = self::get_value( 'featured_image', $settings );
        $featured_image_size = self::get_value( 'featured_image_size', $settings );
        $show_badge = self::get_value( 'show_badge', $settings );
        $taxonomy_badge = self::get_value( 'taxonomy_badge', $settings );
    ...
    public static function render_crossroad_markup( $settings = [], $post ) {
        $featured_image = self::get_value( 'featured_image', $settings );
        $featured_image_size = self::get_value( 'featured_image_size', $settings );
        $show_badge = self::get_value( 'show_badge', $settings );
        $taxonomy_badge = self::get_value( 'taxonomy_badge', $settings );
